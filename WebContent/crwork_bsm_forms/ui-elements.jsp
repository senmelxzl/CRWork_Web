	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="ui-elements.jsp" class="active-menu"><i
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<br /> <i class="fa fa-flask "></i> <i
									class="fa fa-flask fa-2x"></i> <i class="fa fa-flask fa-3x"></i>
								<i class="fa fa-flask fa-4x"></i> <i class="fa fa-flask fa-5x"></i>
								<br />
								<p>
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							...
							<div class="panel-body">Lorem ipsum dolor sit amet,
								...
								ut labore et doloreullamco laboris nisi ut aliquip ex ea commodo
